...
const tabs = ref([
  ...
  },
  {
    ...
    options: {
      ...
      "linux_headless_vaapi_dmabuf_capture": "disabled",
...
function optionSearchMetadata(optionKey) {
  const aliases = {
    ...
    linux_headless_vaapi_dmabuf_capture: ["vaapi dmabuf", "amd headless fps", "ext image copy capture", "60fps cap", "gpu capture"],
