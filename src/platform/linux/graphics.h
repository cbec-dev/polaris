...
#define POLARIS_STRINGIFY_HELPER(x) #x
#define POLARIS_STRINGIFY(x) POLARIS_STRINGIFY_HELPER(x)
#define gl_drain_errors_helper(x) gl::drain_errors(x)
#define gl_drain_errors gl_drain_errors_helper(__FILE__ ":" POLARIS_STRINGIFY(__LINE__))
